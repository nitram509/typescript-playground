...
public class WebMvcConfiguration extends WebMvcConfigurerAdapter {
  ...
  public void addResourceHandlers(ResourceHandlerRegistry registry) {
    String browserContentFolder = determineStaticBrowserContentFolder();
    log.info(">>> Using static browser content folder: " + browserContentFolder);
    registry.addResourceHandler("/**")
        .addResourceLocations("classpath:/static/", "file:" + browserContentFolder + "/");
  }

  private String determineStaticBrowserContentFolder() {
    File pwd = new File(".");
    return new File(pwd.getParentFile(), "browser-namespaces").getAbsolutePath();
  }
